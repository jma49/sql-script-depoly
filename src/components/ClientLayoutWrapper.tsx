...
type TranslationKeys = 'title' | 'description' | 'internalTool' | 'changeLanguage' | 'english' | 'chinese' | 'footerText';
...
// Translations object
const layoutTranslations: Record<'en' | 'zh', Record<TranslationKeys, string>> = {
  en: {
...
export function ClientLayoutWrapper({ children, fontClassName }: ClientLayoutWrapperProps) {
                  ...
                  <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="outline" size="icon" className="rounded-full w-8 h-8 sm:w-9 sm:h-9">
